...
const INDUSTRY_CONFIGS = {
  ...
  MOTOPARTS: { label: 'MotoParts', modules: COMMON_MODULES.concat(['pedidos', 'comercial', 'logistica', 'traslados', 'generar-qr', 'escaner']), inventoryTypes: ['REPUESTOS_MOTO', 'ACCESORIOS_MOTO', 'CONSUMIBLES', 'LUBRICANTES', 'HERRAMIENTAS', 'MOTOCICLETAS'], fields: ['referencia_fabricante', 'referencia_oem', 'referencias_alternas', 'marca_moto', 'linea_moto', 'modelo_moto', 'anio_inicial', 'anio_final', 'cilindraje', 'vin', 'numero_motor', 'ubicacion_motoparts', 'proveedor_origen'], dashboardWidgets: ['critical_parts', 'vin_traceability', 'moto_reorder', 'provider_locations'] },
